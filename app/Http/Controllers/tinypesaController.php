...
{
    public function tinypesaStk()
    {
        $amount = '1'; // Amount to transact
        $phonenumber = '0743316661'; // Phone number paying
        ...
        $headers = array(
            ...
            'ApiKey: fIWVihHaOGg' // Replace with your API key
        );
    ...
    public function tipesaCallback()
    {
        ...
        // You might want to send a response back to TinyPesa here
