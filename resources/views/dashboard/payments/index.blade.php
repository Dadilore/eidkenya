                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                        <thead>
                            <tr class="fs-7 fw-bold text-gray-500 border-bottom-0">                                    
                                <th class="p-0 pb-3 min-w-175px text-start">PAYMENT FOR</th>
                                <th class="p-0 pb-3 min-w-100px text-end">PAID ON</th>
                                <th class="p-0 pb-3 min-w-100px text-end pe-12">PAYMENT STATUS</th>                             
                        ...
                        <tbody>
                            ...
                            <tr>                            
                                ...
                                <td class="text-end pe-12">
                                    <span class="badge py-3 px-4 fs-7 badge-light-danger">Pending</span>
                                </td>   
