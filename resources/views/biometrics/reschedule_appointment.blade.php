...
<div class="container">
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center mb-2">
                                    <span class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">Reschedule Biometrics Capture Appointment</span>
                                </div>
    ...
    <div class="container">
        <form action="{{url('edit_appointment',$data->id)}}"  method="POST" enctype="multipart/form-data" >
                @csrf
