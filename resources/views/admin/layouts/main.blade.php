...
<html lang="en">
  ...
  <head>
    ...
    <link
    href="{{ asset('user/plugins/custom/datatables/datatables.bundle.css') }}"
      rel="stylesheet"
      type="text/css"
    />
    ...
    <link
      href="{{ asset('user/plugins/global/plugins.bundle.css') }}"
      rel="stylesheet"
      type="text/css"
    />
  ...
  >
    ...
    <script src="{{ asset('user/js/custom/pages/user-profile/general.js') }}"></script>
    ...
    <script src="{{ asset('user/js/custom/utilities/modals/offer-a-deal/type.js') }}"></script>
    <script src="{{ asset('user/js/custom/utilities/modals/offer-a-deal/details.js') }}"></script>
    <script src="{{ asset('user/js/custom/utilities/modals/offer-a-deal/finance.js') }}"></script>
