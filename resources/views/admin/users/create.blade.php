					...
					<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
						<div class="d-flex flex-column">
							<div class="d-flex align-items-center mb-2">
								<span class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">Add User</span>
							</div>
		...
		<div class="d-flex flex-column flex-lg-row-fluid  ">
			...
			<div class="d-flex flex-center flex-column flex-lg-row-fluid s">
				...
				<div class="w-100 py-10 px-5">
					<!--begin::Form-->
					<form method="POST" action="{{ route('admin.users.store') }}" class="form w-100" novalidate="novalidate">
					@csrf
