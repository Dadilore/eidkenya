                    ...
                    <div id="1">
                        ...
                        <div>
                            <p class="fs-6 fw-semibold text-gray-600">
                                1. <b>Duly fill and submit</b> the application form found <a href="{{ route('application') }}">here.</a>
                            </p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Enter full names" wire:model="full_names">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Enter date of birth" wire:model="date_of_birth">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" wire:model="gender">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="enter your occupation" wire:model="occupation">
                                    <span class="text-danger">@error('occupation'){{ $message }}@enderror</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="enter your telephone number"wire:model="telephone_number">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="enter your email "wire:model="email">
                                    <span class="text-danger">@error('email'){{ $message }}@enderror</span>
                                </div>
                            </div>
                        </div>
