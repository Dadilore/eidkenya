...
<section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li style="color: #008000;">requirements</li>
          </ol>
        </div>
     ...
     <section id="requirements" class="requirements">
      ...
      <div class="section-title">
          <h2>Requirements for First time applicants</h2>
          <p></p>
        </div>
    ...
    <section id="requirements" class="requirements">
      ...
      <div class="section-title">
          <h2>Requirements for Replacement/Lost/Mutilated/Duplicate ID cards applicants</h2>
          <p></p>
        </div>
    ...
    <section id="requirements" class="requirements">
      ...
      <div class="section-title">
          <h2>Requirements for Change of Particulars Applicants</h2>
          <p></p>
        </div>
