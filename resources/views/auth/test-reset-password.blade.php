...
<base href="../../../" />
	...
	<body id="kt_body" class="app-blank">
				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							...
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" action="{{ route('password.store') }}" method="POST">
                                 @csrf
                                ...
                                <div>
                                    ...
                                    <x-text-input id="email" class="form-control bg-transparent mb-5" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
								...
								<div class="fv-row mb-8">
									...
									<input id="password_confirmation" type="password" placeholder="Repeat Password" name="password_confirmation"required autocomplete="new-password" class="form-control bg-transparent" />
									<!--end::Repeat Password-->
				...
				<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url({{ asset('user/media/misc/auth-bg.png') }})">
					...
					<div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
						...
						<a href="index.html" class="mb-0 mb-lg-12">
							<img alt="Logo" src="{{ asset ('assets/images/logo/logo_w_t.png') }}" class="h-60px h-lg-75px" />
						</a>
						<!--end::Logo-->
						<!--begin::Image-->
		...
		<script src="{{ asset('user/js/custom/authentication/reset-password/new-password.js') }}"></script>
